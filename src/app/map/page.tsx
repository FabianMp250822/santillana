  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <div className="text-center mb-8">
        <h1 className="font-headline text-4xl md:text-5xl font-bold">Interactive Project Map</h1>
        <p className="mt-2 text-lg text-muted-foreground">Click on a lot to view its details and availability.</p>
      </div>
